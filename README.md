...
<title>19 lettres — Joyeux 19 ans 🎉</title>
...
<header>
  <h1>Joyeux 19ᵉ anniversaire 🎉</h1>
  <p class="lead">19 lettres spéciales pour ta sœur — couleur bordeaux & doré</p>
</header>
...
<main class="container">
  ...
  <footer class="controls">
    <button class="btn" id="shuffleBtn">Mélanger l'ordre</button>
    ...
    <button class="btn" id="celebrateBtn">Lancer la fête ✨</button>
  </footer>
</main>
...
/* --------- Contenu des 19 lettres ---------
   ...
   Chaque élément a : title (court) et text (contenu complet, peut contenir <br>).
-------------------------------------------*/
const lettersContent = [
  {title: "Lettre 1", titleShort: "1", text: "Ma chère sœur,<br>Pour tes 19 ans je te souhaite tout le bonheur du monde. Tu es incroyable."},
  {title: "Lettre 2", titleShort: "2", text: "Ta gentillesse illumine nos journées. N'oublie jamais ta valeur."},
  {title: "Lettre 3", titleShort: "3", text: "Que cette année t'apporte des rêves réalisés et des fous rires partagés."},
  {title: "Lettre 4", titleShort: "4", text: "Continue à oser, à apprendre et à t'aimer."},
  {title: "Lettre 5", titleShort: "5", text: "Je suis fier·e de toi chaque jour."},
  {title: "Lettre 6", titleShort: "6", text: "Souviens-toi : même les petites victoires comptent."},
  {title: "Lettre 7", titleShort: "7", text: "Reste curieuse et garde ce cœur généreux."},
  {title: "Lettre 8", titleShort: "8", text: "Pour toi : une année pleine d'aventures."},
  {title: "Lettre 9", titleShort: "9", text: "Que l'amour et la santé te suivent partout."},
  {title: "Lettre 10", titleShort: "10", text: "N'hésite pas à demander de l'aide — tu n'es jamais seule."},
  {title: "Lettre 11", titleShort: "11", text: "Garde ta force, même dans les moments d'incertitude."},
  {title: "Lettre 12", titleShort: "12", text: "Tu es capable de grandes choses — crois en toi."},
  ...
  {title: "Lettre 15", titleShort: "15", text: "Rêve grand, travaille avec cœur, et savoure le voyage."},
  {title: "Lettre 16", titleShort: "16", text: "Un énorme câlin (virtuel) et tout mon amour."},
  {title: "Lettre 17", titleShort: "17", text: "Merci d'être toi — authentique et lumineuse."},
  {title: "Lettre 18", titleShort: "18", text: "19 sera une belle année — prête pour l'aventure ?"},
  {title: "Lettre 19", titleShort: "19", text: "Bonne fête ! On t'aime fort ❤️"}
];
